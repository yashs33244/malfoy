...
export default function FaqSection() {
  ...
  const faqItems: FaqItem[] = [
    {
      question: "How does PriceIQ collect competitor pricing data?",
      answer:
        "PriceIQ uses advanced web scraping technology and API integrations to collect real-time pricing data from competitor websites and marketplaces. Our system is designed to respect robots.txt files and adhere to all legal requirements for data collection.",
      category: "general",
    },
    {
    ...
    {
      question: "Can I integrate PriceIQ with my e-commerce platform?",
      answer:
        "Yes, PriceIQ integrates seamlessly with all major e-commerce platforms including Shopify, WooCommerce, Magento, BigCommerce, Amazon, eBay, and more. We also offer API access for custom integrations on our Enterprise plan.",
    ...
    {
      question: "How secure is my data on PriceIQ?",
      answer:
    ...
    {
      question: "Can I export data from PriceIQ?",
      answer:
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          <p className="text-muted-foreground">
            Find answers to common questions about PriceIQ and our pricing intelligence platform.
          </p>
        </div>
            ...
            {categories.map((category) => (
              <button
                ...
                className={`px-4 py-2 rounded-full text-sm ${
                  activeCategory === category.id ? "bg-primary text-white" : "bg-muted hover:bg-muted/80"
                }`}
